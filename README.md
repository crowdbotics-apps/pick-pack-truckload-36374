...
## Project Structure
    ...
    ├── pick_pack_truckload_36374  # Django project configurations
...
1. Clone this repo and `cd pick_pack_truckload_36374`
...
2. Clone this repo and `cd pick_pack_truckload_36374`
